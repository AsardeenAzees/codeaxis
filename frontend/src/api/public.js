...
// Aggregate API for compatibility with components importing { publicAPI }
export const publicAPI = {
  ...
  sortPublicProjects,
  paginatePublicProjects,
  getPublicProjectCount,
  getPublicProjectSummary,
  getPublicProjectTrends,
  getPublicProjectAnalytics,
  getPublicProjectInsights,
  getFeaturedProjects,
  getRecentProjects,
  getPopularProjects,
  getTrendingProjects,
  ...
  getMostCommentedProjects,
  getMostBookmarkedProjects,
  getRelatedProjects,
  getSimilarProjects,
  ...
  getPublicProjectKPIs,
  getPublicProjectDashboard,
  getPublicProjectRecommendations,
  getPublicProjectSuggestions,
  getPublicProjectAutocomplete,
};