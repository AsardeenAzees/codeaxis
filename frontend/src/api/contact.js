...
// Aggregate API for compatibility with components importing { contactAPI }
export const contactAPI = {
  ...
  getContactFormValidationRules,
  getContactFormOptions,
  getContactFormTemplates,
  getContactFormSettings,
  getContactFormAnalytics,
  getContactFormSummary,
  getContactFormTrends,
  getContactFormReports,
  getContactFormDashboard,
  getContactFormInsights,
  getContactFormRecommendations,
  getContactFormSuggestions,
  getContactFormAutocomplete,
  getContactFormSearch,
  getContactFormAdvancedSearch,
  getContactFormFilter,
  getContactFormSort,
  getContactFormPaginate,
  getContactFormCount,
  getContactFormSummaryByDate,
  getContactFormSummaryByUser,
  getContactFormSummaryBySource,
  getContactFormSummaryByStatus,
  getContactFormSummaryByPriority,
  getContactFormSummaryByType,
  getContactFormSummaryByCategory,
  getContactFormSummaryByTag,
};